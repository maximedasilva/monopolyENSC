 ...
 * 
 */
public class Deplacement : Cartes {//Carte de déplacement
    ...
    public Deplacement(TypeC typecarte, string fct,int depRel, int depAbs):base (typecarte, fct)//Constructeur
    {
